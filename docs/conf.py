#!/usr/bin/env python
"""
sedna documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, "..", "sedna"))
sys.path.insert(0, src_path)
src_path = os.path.abspath(os.path.join(docs_src_path, ".."))
sys.path.insert(0, src_path)


import sedna.core  # noqa
...
project = "sedna"
_full_version = sedna.core.__version__
author = sedna.core.__author__
copyright = sedna.core.__copyright__
